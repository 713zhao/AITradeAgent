...
class AppConfig(BaseModel):
    ...
    strategy_memory_db_path: str = "storage/strategy_actor.sqlite"
    risk_memory_db_path: str = "storage/risk_actor.sqlite"
    learning_memory_db_path: str = "storage/learning_actor.sqlite"
